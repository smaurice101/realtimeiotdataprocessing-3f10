[realtimeiotdataprocessing-3f10] Operating Details
====================================

Generated On: 2024-10-12 23:37:40 UTC
...
.. important::
   ...
   **not be valid if your [realtimeiotdataprocessing-3f10] container is NOT running**.

.. tip::
   You must have your [realtimeiotdataprocessing-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   http://localhost:54515/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:54515/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   maadsdocker/realtimeiotdataprocessing-3f10-amd64 (https://hub.docker.com/r/maadsdocker/realtimeiotdataprocessing-3f10-amd64)
...
.. important::
   docker run -d -p 51099:51099 -p 55113:55113 -p 37369:37369 \-\-env TSS=0 \-\-env SOLUTIONNAME=realtimeiotdataprocessing-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_dag-realtimeiotdataprocessing-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=51099  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=55113  \-\-env SOLUTIONVIPERVIZPORT=37369 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=43595 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=54515 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/realtimeiotdataprocessing-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=37369
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=51099
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/realtimeiotdataprocessing-3f10-amd64
...
It can be accessed by entering: http://localhost:55113
...
.. important::
   http://localhost:37369/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:37369/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:37369/<html file>
...
[realtimeiotdataprocessing-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/realtimeiotdataprocessing-3f10
...
.. important::
   https://realtimeiotdataprocessing-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_dag-realtimeiotdataprocessing-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=51099, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=38051, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33505, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46741, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34823, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45207, HPDEHOST=127.0.1.1, HPDEPORT=42243, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41479

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5048-realtimeiotdataprocessing-3f10,solution_preprocessing_dag-realtimeiotdataprocessing-3f10, python-preprocess-4838-realtimeiotdataprocessing-3f10,solution_preprocessing_dag-realtimeiotdataprocessing-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
